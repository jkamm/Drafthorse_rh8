    ...
    public class DetailEdit_OBSOLETE : Base.DH_ButtonComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            */
            ...
            Grasshopper.Rhinoceros.Display.ModelView view = new Grasshopper.Rhinoceros.Display.ModelView();
            if (!DA.GetData("View", ref view)) view = new Grasshopper.Rhinoceros.Display.ModelView(new Rhino.DocObjects.ViewportInfo(detail.Viewport));
            else
            {
            ...
            */
            ...
            if (Execute || run)
            {
                ...
                Rhino.Commands.Result detailResult = Helper.Layout.ReviseDetail(detail, targetBBox, scale, projection, displayMode, view.ToViewportInfo());
            ...
            DA.SetData("View", new Grasshopper.Rhinoceros.Display.ModelView(new Rhino.DocObjects.ViewportInfo(detail.Viewport)));
        }
