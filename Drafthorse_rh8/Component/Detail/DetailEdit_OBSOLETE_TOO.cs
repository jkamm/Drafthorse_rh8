...
{
    public class DetailEdit_OBSOLETE_TOO: Base.DH_ButtonComponent
    {
        ...
        /// </summary>
        public DetailEdit_OBSOLETE_TOO()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Execute || run)
            {
                ...
                Rhino.Commands.Result detailResult = Helper.Layout.ReviseDetail(detail, target, scale, projection, displayMode);
