...
{
    public class LayoutGetIndex_OBSOLETE : Base.DH_UpdateButtonComponent
    {
        #region GH_Component
        /// <summary>
        /// Initializes a new instance of the GetLayoutIndex class.
        /// </summary>
        public LayoutGetIndex_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            int[] pages = Helper.Layout.GetPages(name);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Drafthorse_rh8.Properties.Resources.LayoutIndex;
