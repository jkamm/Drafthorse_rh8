...
{ 
    public class LayoutCopy_OBSOLETE : Base.DH_ButtonComponent
    {
        #region GH_Component
        /// <summary>
        /// Initializes a new instance of the CopyLayout class.
        /// </summary>
        public LayoutCopy_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (run || Execute)
            {
                Rhino.Display.RhinoPageView template = Helper.Layout.GetPage(templateIndex);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon=> Drafthorse_rh8.Properties.Resources.CopyLayout_bitmap;
