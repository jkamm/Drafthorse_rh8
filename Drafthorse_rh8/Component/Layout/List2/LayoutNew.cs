...
namespace Drafthorse.Component.Layout.List2
{
    public class LayoutNew : Base.DH_ButtonComponent
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            Param_Integer obj = (Param_Integer)pManager[7];
            obj.AddNamedValue("Inches", 0);
            obj.AddNamedValue("Centimeters", 1);
            obj.AddNamedValue("Millimeters", 2);
        }
        ...
        {
            get { return new Guid("12466f84-bd42-4523-a84a-97895dd7d263"); }
        }
        /*
