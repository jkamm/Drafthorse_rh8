...
{
    public class LayoutDeconstruct_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the DeconstructLayout class.
        /// </summary>
        public LayoutDeconstruct_OBSOLETE()
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("LayoutIndex", "Li[]", "Index of a Layout (from LayoutIndex Drafthorse) /nAttach Value List for Layout List", GH_ParamAccess.item);
        }
